//! # The Async Standard Implementation
//!
//! This includes an implementation of the protocol for the async-std runtime.
//!
//! ## Creating a server
//!
...
pub use futures::StreamExt as EventStreamExt;
